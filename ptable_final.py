...
def number_sort(number_dict):
    ...
    print("\nSorting periodic table by number.\n", file=display_file)
...
gases=[1,2,6,7,8,9,10,15,16,17,18,34,35,36,53,54,86]
...
while check:
    while marker==1:
        ...
        if initial_yn == "y":
            ...
            if user_int in metalloids:
                print(f"{details[1]} is a metalloid.")
                print(f"{details[1]} is a metalloid.\n", file=display_file)
            elif user_int in gases:
                print(f"{details[1]} is a gas.")
                print(f"{details[1]} is a gas.\n", file=display_file)
            else:
    ...
    while marker==4:
        ...
        if group_yn == "y":
            ...
            print(f"\nGroup {group_view} elements: {group_select}\n", file=display_file)
            marker = 5
        elif group_yn == "n":
            marker = 5
        else:
